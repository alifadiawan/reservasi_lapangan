                ...
                <tbody>
                    <tr>
                        ...
                        <td class="container" width="600">
                            <div class="content">
                                <div class="row w-25 mb-4">
                                    <a href="{{ route('siswa.index') }}" class="btn btn-outline-danger">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="content-block">
                                                                <h2 class="text-dark">{{ $reservasi->penanggungjawab }}</h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="content-block">
                                                                <table class="invoice">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>{{ $reservasi->penanggungjawab }}<br>Kode
                                                                                Booking
                                                                                <strong>{{ $reservasi->kode_booking }}</strong><br>{{ $reservasi->tanggal }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <table class="invoice-items" cellpadding="0"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="alignleft fw-bold">Alasan Ditolak</td>
                                                                                            <td class="">{{$reservasi->alasan}}
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
